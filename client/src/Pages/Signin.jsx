...
function Signin({ removemargin }) {
    const backgroundImageStyle = {
        backgroundImage: `url('https://www.boutiquecollectionbyamaya.com/villas-wadduwa/wp-content/uploads/sites/12/2022/10/wadduwa-new-desk-header.jpg')`,
    ...
    return (
        ...
        >
            <WebLayout title="Sign in - Dream Villa" removemargin={true}>
                <div style={backgroundImageStyle} class="min-h-screen text-gray-900 flex justify-center w-full h-[102vh] -mt-[100px]">
                    <div class="container m-5 sm:m-10 bg-[#ffffff17] shadow-soft-shadow rounded-3 flex justify-center flex-1 !mt-30">
                        <div class="container">
                            {/* <div className='flex justify-center my-5 md:my-8'>
                                <img class="h-8 w-auto sm:h-10" src="https://drive.google.com/uc?export=view&id=1MFiKAExRFF0-2YNpAZzIu1Sh52J8r16v" alt="" />
                            </div> */}
                            <div class="mt-6 flex flex-col items-center">
                                <div class="w-full flex-1 mt-6">
                                    ...
                                    <div class="my-10 text-center">
                                        <div
                                            class="leading-6 px-10 px-2 inline-block text-sm text-white tracking-wide font-medium transform translate-y-1/2">
