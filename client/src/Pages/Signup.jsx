...
function Signup() {
    const backgroundImageStyle = {
        backgroundImage: `url('https://www.boutiquecollectionbyamaya.com/wp-content/uploads/2022/11/bot-villa-new-mob-header-1.jpg')`,
    ...
    return (
        ...
        >
            <WebLayout title="Sign up - Dream Villa" removemargin={true}>
                <div style={backgroundImageStyle} class=" text-gray-900 flex justify-center w-full  -mt-[100px]">
                            ...
                            <div class="mt-6 flex flex-col items-center">
                                <div class="w-full flex-1 mt-6">
                                    ...
                                    <div class="mx-auto max-w-xs">
                                        ...
                                        <p class="my-6 text-xs text-white text-center">
