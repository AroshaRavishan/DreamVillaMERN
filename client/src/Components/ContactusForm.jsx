...
function ContactusForm() {
    return (
        <div>
            <div class="contact-1 mt-10 md:mt-30">
                        ...
                        <div class="xl:w-10/12 xl:mx-auto px-4">
                            ...
                            <div class="md:flex md:-mx-4 mt-4 md:mt-10">
                                    ...
                                    <div class="contact-form">
                                        <div class="sm:flex sm:flex-wrap -mx-3">
                                            <div class="sm:w-1/2 px-3 mb-6">
                                                <input type="text" placeholder="Full Name" class="border-2 rounded px-3 py-2 w-full focus:border-indigo-400 input"/>
                                            </div>
                                            <div class="sm:w-1/2 px-3 mb-6">
                                                <input type="text" placeholder="Company Name" class="border-2 rounded px-3 py-2 w-full focus:border-indigo-400 input"/>
                                            </div>
                                            <div class="sm:w-1/2 px-3 mb-6">
                                                <input type="text" placeholder="E-mail address" class="border-2 rounded px-3 py-2 w-full focus:border-indigo-400 input"/>
                                            </div>
                                            <div class="sm:w-1/2 px-3 mb-6">
                                                <input type="text" placeholder="Phone Number" class="border-2 rounded px-3 py-2 w-full focus:border-indigo-400 input"/>
                                            </div>
                                        ...
                                        <div class="text-right mt-4 md:mt-12">
                                            <button class="border-2 border-primary rounded px-6 py-2 text-primary hover:bg-primary hover:text-black-900 transition-colors duration-300">
                                                Send a Message
                                ...
                                <div class="md:w-1/3 md:px-4 mt-10 md:mt-0">
                                    <div class="bg-primary rounded py-4 px-6">
                                        <h5 class="text-xl font-medium mb-3">Help</h5>
                                        <p class="text-black-900 mb-4">Need help or have any query? Don't hesitate, you can directly shoot us an <a href="mailto:" class="text-indigo-600 border-b border-transparent hover:border-indigo-600 inline-block">email</a> or call us at <a href="tel:" class="text-indigo-600 border-b border-transparent hover:border-indigo-600 inline-block">+1 231 456 1231</a></p>
                                        <p class="text-black-900">You can move to <a href="#" class="text-indigo-600 border-b border-transparent hover:border-indigo-600 inline-block">FAQs</a> or <a href="#" class="text-indigo-600 border-b border-transparent hover:border-indigo-600 inline-block">Support</a> page to get more information about our site.</p>
                                    </div>
                                </div>
